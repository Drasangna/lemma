...
export async function requireApiUser(){const user=await getChatGPTUser();if(!user)throw new ApiError(401,"Sign in with ChatGPT to use this private workspace.");return user}
