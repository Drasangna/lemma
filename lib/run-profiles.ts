...
const deepseek:ModelRef={model:"deepseek/deepseek-chat",reasoning:"low",maxOutputTokens:3000};
const openai:ModelRef={model:"openai/gpt-4o-mini",reasoning:"low",maxOutputTokens:3000};
...
export const DEEP_MODELS:Array<{id:string;label:string}> = [
